...
import { gui, view as routerView } from 'lib/const';
...
const Event = (props) => {
  return (
    <ApolloProvider client={client}>
      <EventQuery address={props.address} view={props.view} proposalId={props.proposalId} first={props.first} skip={props.skip} orderBy={props.orderBy} orderDirection={props.orderDirection} />
    </ApolloProvider>
  );
};
