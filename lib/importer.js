...
if (Meteor.isServer) {
  ...
  proposals to be implemented on Decentraland\'s metaverse.',
  contractURI('district polls'),
  `${_getURLDate(pseudoDraft)}${contractURI('district polls')}`, firstItem[7],
  '0x131bdccea95a29d8ca04347c87d1a6a5e099ee81', _getBlockTime(new
  Date(firstItem[7])), new Date(firstItem[7]));
