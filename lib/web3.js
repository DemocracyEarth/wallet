...
* @param {string} publicAddress to check balance on chain
*/
const _getToken = async (publicAddress) => {
  ...
  const tokenId = await insertToken(template);
  log(`[web3] Token insterted with id: ${tokenId}`);
