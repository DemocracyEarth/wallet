...
Router.route('/:feed', {
  ...
  template: 'home',
  waitOn: function () {
    return [Meteor.subscribe('contracts', _buildQuery(this.params.query)), Meteor.subscribe("userData")];
  },
  onBeforeAction: function () {
    _clearSessionVars();
...
Router.route('/tag/:tag', {
  ...
  template: 'home',
  waitOn: function () {
    return [Meteor.subscribe('contracts', _buildQuery(this.params)), Meteor.subscribe("userData")];
  },
  onBeforeAction: function () {
    _clearSessionVars();
