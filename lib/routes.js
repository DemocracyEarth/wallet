...
let _loadContract = (view, id) => {
  ...
  if (contract != undefined) {
    ...
    Session.set('rightToVote', Modules.both.rightToVote(contract));

    //set wallet to use
    var userContract = new Boolean(false);
    console.log(userContract);
    for (i in contract.signatures) {
      console.log(contract.signatures[i]._id);
