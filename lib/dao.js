...
if (Meteor.isServer) {
  /*Contracts.update({ _id: 'mjztac5D7amBAjTgB' }, { $set: {
    title: 'hola',
    blockchain: {
      tickets: [
        {
  ...
  console.log('holalalallala', 'mjztac5D7amBAjTgB');
  console.log(Contracts.findOne({ _id: 'mjztac5D7amBAjTgB' }).blockchain.tickets, 'mjztac5D7amBAjTgB');*/
  _setupDAOs();
}
