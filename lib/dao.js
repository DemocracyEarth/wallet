...
const _refreshDAOs = async () => {
  ...
  console.log(`[dao] Laset synced block on server ${lastServerSyncedBlock} and the current block: ${currentBlock}`);
  ...
  log(`[dao] Last synced block on server: ${lastServerSyncedBlock}`);
};
