...
_views.bothDelegationContracts = (terms) => {
  if (Meteor.user()) {
    ...
    if (delegations.length === 0 || (delegations.length === 1 && delegations.signatures[0]._id === terms.delegateId)) {
    ...
    if (delegations.length === 0 || (delegations.length === 1 && delegations.signatures[0]._id === Meteor.userId())) {
