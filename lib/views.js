...
_views.delegationVotes = (terms) => {
  ...
  log(`{ view: 'delegationVotes', user: ${logUser()} }`);
  console.log(contractId);
  return {
    find: { kind: 'DELEGATION', $or: [{ 'output.entityId': contractId }, { 'input.entityId': contractId }, { 'output.delegateId': contractId }, { 'input.delegateId': contractId }] },
    options: { limit: 25, sort: terms.sort },
  };
};
