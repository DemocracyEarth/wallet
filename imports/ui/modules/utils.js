    ...
    switch (Session.get('contract').kind) {
      case 'DELEGATION':
        ...
        if (profile != undefined) {
          checkedText = checkedText.replace('<delegator>', "<a href='/@" + username['DELEGATOR'] + "'>" + _getProfileName(profile['DELEGATOR']) + htmlTagClose);
          checkedText = checkedText.replace('<delegate>', "<a href='/@" + username['DELEGATE'] + "'>" + _getProfileName(profile['DELEGATE']) + htmlTagClose);
